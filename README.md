...
- `randomize` - *default: "letters";* Expects a value of "letters" or "words", any other value fades the entire text block evenly.
- `baseOpacity` - *default: 100;* A starting value for the opacity, expected value between 0 and 100.
...
- `missingOpacity` - *default: -1 (disabled);* - The time between opacity updates.
- `missingText` - *default: "?";* - A character to replace "missing" text chunks with.
